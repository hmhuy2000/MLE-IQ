...
# CUDA_VISIBLE_DEVICES=0 python train_IQ.py env=ant agent=sac \
...
# CUDA_VISIBLE_DEVICES=0 python train_IQ.py env=humanoid agent=sac \
...
# CUDA_VISIBLE_DEVICES=3 python trainIQ.py env=walker2d agent=sac \
...
# CUDA_VISIBLE_DEVICES=3 python trainIQ.py env=hopper agent=sac \
