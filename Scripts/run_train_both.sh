# CUDA_VISIBLE_DEVICES=3 python train_both.py env=cheetah agent=sac \
...
# env.num_sub_optimal_demo=[100000,50000,20000,5000] \
...
# CUDA_VISIBLE_DEVICES=0 python train_both.py env=walker2d agent=sac \
