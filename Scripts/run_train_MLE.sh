# CUDA_VISIBLE_DEVICES=1 python train_MLE.py env=cheetah agent=sac \
...
# env.lambda_coef=[2e-5,2e-5,2e-5] \
...
# CUDA_VISIBLE_DEVICES=3 python train_MLE.py env=hopper agent=sac \
...
# env.num_sub_optimal_demo=[100,100,100,10] \
# expert.reward_arr=[0.2,0.5,0.8,1.0] \
# env.lambda_coef=[2e-5,2e-5,2e-5] \
# agent.actor_lr=3e-04 agent.critic_lr=3e-04 \
# seed=7