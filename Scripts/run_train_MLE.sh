...
# env.lambda_coef=[1e-5,1e-5,1e-5] \
# agent.actor_lr=3e-04 agent.critic_lr=3e-04 seed=0 

# CUDA_VISIBLE_DEVICES=2 python train_MLE.py env=ant agent=sac \
# env.name=Ant-v3 \
...
# env.lambda_coef=[1e-5,1e-5,1e-5] \
# agent.actor_lr=3e-04 agent.critic_lr=3e-04 \
# q_net.hidden_dim=256 q_net.hidden_depth=3 seed=7

# CUDA_VISIBLE_DEVICES=3 python train_MLE.py env=walker2d agent=sac \
...
# env.lambda_coef=[1e-5,1e-5,1e-5] \
# agent.actor_lr=3e-04 agent.critic_lr=3e-04 \
# q_net.hidden_dim=256 q_net.hidden_depth=3 seed=1

# CUDA_VISIBLE_DEVICES=1 python train_MLE.py env=hopper agent=sac \
...
# env.lambda_coef=[1e-5,1e-5] \
# agent.actor_lr=3e-04 agent.critic_lr=3e-04 \
# agent.q_net.hidden_dim=256 agent.q_net.hidden_depth=1 seed=7